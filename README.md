...
[![Docker Image](https://img.shields.io/badge/docker-ghcr.io%2Fazfarh95%2Fsentinel--smdl-blue?logo=docker)](https://github.com/azfarh95/sentinel-smdl/pkgs/container/sentinel-smdl)
[![Release](https://img.shields.io/github/v/release/azfarh95/sentinel-smdl)](https://github.com/azfarh95/sentinel-smdl/releases)
[![License: MIT](https://img.shields.io/badge/license-MIT-blue.svg)](LICENSE)

Carved out of the [Project Sentinel](https://github.com/azfarh95/sentinel-stack-public) homelab stack as a deployable-anywhere component. Runs on a single Docker host (amd64 or arm64). No AI dependencies — same code can be re-wrapped as an MCP tool for LLM-agent use via the `RecorderBridge` interface.
...
docker run -d \
  ...
  ghcr.io/azfarh95/sentinel-smdl:v1.0.0
```
...
```bash
git clone https://github.com/azfarh95/sentinel-smdl
cd sentinel-smdl
...
Images published to [`ghcr.io/azfarh95/sentinel-smdl`](https://github.com/azfarh95/sentinel-smdl/pkgs/container/sentinel-smdl) on every tag push:
...
**V1 stable** (released [v1.0.0](https://github.com/azfarh95/sentinel-smdl/releases/tag/v1.0.0)). In hardening/soak period — 1-2 months of daily-use validation before V2 work begins.
...
Bug reports + PRs welcome at [github.com/azfarh95/sentinel-smdl/issues](https://github.com/azfarh95/sentinel-smdl/issues). Site-specific extractor work is preferred upstream at [yt-dlp](https://github.com/yt-dlp/yt-dlp) — this repo's plugin tier is the right place for SMDL-specific wiring (URL detection, Cloudflare hosts, etc.) only.
