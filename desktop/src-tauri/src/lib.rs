// Sentinel SMDL desktop entry — a thin Tauri 2 wrap around the remote
// Mini App at https://media.az-sentinel.xyz/iptv.
//
...
pub fn run() {
    tauri::Builder::default()
        ...
        .expect("error while running Sentinel SMDL desktop");
}
